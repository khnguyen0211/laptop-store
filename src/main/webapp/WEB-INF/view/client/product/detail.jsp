                    ...
                    <div class="container-fluid py-5 mt-5">
                        <div class="container py-5 mt-5">
                            <div class="row g-4 mb-5">
                                <div class="col-lg-8 col-xl-9" modelAttribute="product">
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                ...
                                <div class="col-lg-4 col-xl-3">
                                    <div class="row g-4 fruite">
                                        ...
                                        <div class="col-lg-12" modelAttribute="products">
                                                ...
                                                <div class="d-flex align-items-center justify-content-start"
                                                    ...
                                                    <div class="mx-3">
                                                        <h6 class="mb-2"><a style="color: black;"
                                                                href="/products/${product.id}">${product.name}</a></h6>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="position-relative">
                                                    <img src="/client/img/banner-fruits.jpg"
