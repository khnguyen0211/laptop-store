(function ($) {
  ...
  $(".quantity button").on("click", function () {
    ...
    if (priceElement) {
      ...
      priceElement.text(formatCurrency(newPrice.toFixed(2)) + " abc");
    }

    //update total cart price
    const totalPriceElement = $(`b[data-cart-total-price]`);

    if (totalPriceElement && totalPriceElement.length) {
      const currentTotal = totalPriceElement.attr("data-cart-total-price");
